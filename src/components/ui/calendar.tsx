  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-secondary font-semibold text-foreground",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-secondary aria-selected:text-muted-foreground aria-selected:opacity-30",
